...
SRC_SIGNALS		=	signals/signal_handling.c signals/signal_utils.c
...
SRC_EXPAND		:=	parsing/expand/expand.c parsing/expand/utils.c \
					parsing/expand/utils2.c parsing/expand/utils3.c parsing/expand/utils4.c parsing/expand/utils5.c
...
SRC_EXEC		=	execution/executions_utils/execution.c execution/executions_utils/loop_execution.c \
					...
					execution/here_docs/here_doc_handle.c execution/here_docs/here_docs_utils.c execution/here_docs/here_doc_expand.c
