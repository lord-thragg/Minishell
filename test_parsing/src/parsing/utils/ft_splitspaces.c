...
/*   Updated: 2025/04/01 15:00:43 by luluzuri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	**free_tokens(char **result, int i)
{
    while (i > 0)
        free(result[--i]);
    free(result);
...
static char	*get_next_token(const char **s, int *len)
{
    const char	*start;
...
static char	**fill_tokens(const char *s, char **result, int tokens_count)
{
    int		i;
    int		len;
    char	*start;
